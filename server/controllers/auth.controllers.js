...
const generateAuthToken = async (req, res) => {
    try {
        if (req.isAuthenticated()) {
            ...
            await res.redirect(`https://sellmobile-wtjan2019-qa-client.azurewebsites.net?authtoken=${req.user.token}`);
        }
    } catch (err) {
        res.status(500).json({
            message: 'User not authenticated',
...
const forgotPassword = async (req, res, next) => {
    ...
    try {
        ...
        var mailOptions = {
            ...
            text: `click this to reset your password : <a href="https://sellmobile-wtjan2019-qa-client.azurewebsites.net/resetpassword">reset</a>`,

            html: `Dear <b>${firstName},</b>  <br>
                    <b>click this to reset your password : <a href="https://sellmobile-wtjan2019-qa-client.azurewebsites.net/resetpassword/${tokens.token}">reset</a></b>
